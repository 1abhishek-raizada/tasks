...
bt=Button(root,text='+',font=(11),height=1,width=3,command=add,bg='black',foreground='white')
...
bt4=Button(root,text='÷',font=(11),height=1,width=3,command=div,bg='black',foreground='white')
