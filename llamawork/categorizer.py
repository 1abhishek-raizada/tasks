...
try:
    ...
    print('generated categorized text: ',generated_text)
    #writing the categorized list to the output file
    with open(output_file,"w") as f:
        f.write(generated_text.strip())

    print(f"Categorized grocery list has been saved to '{output_file}' file.")
